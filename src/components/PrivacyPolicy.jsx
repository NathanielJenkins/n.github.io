	...
	return (
		<>
			...
			<p>
				...
				Name (“Application”) for mobile devices that was created
				by&nbsp;Developer Company Name.&nbsp;The Application is&nbsp;Basic
			...
			<p>
				...
				However, please keep in mind that you may not be able to use some of the
			...
			<p>
				...
				contact us for help; (d) credit card information for purchase and use of
				the Application, and; (e) information you enter into our system when
			...
			<p>
				...
				services to help us improve the Application and our service.&nbsp;We
				will share your information with third parties only in the ways that are
			...
			<ul>
				...
				<li>
					...
					<p>
						...
						and have agreed to adhere&nbsp;to the rules set forth in this
						privacy statement.
					</p>{" "}
				</li>
				<li>
					{" "}
					<p>
						if&nbsp;Developer Company Name&nbsp;is involved in a merger,
						acquisition, or sale of all or a&nbsp;portion of its assets, you
						will be notified via email and/or a prominent notice on our Web site
						of any change in ownership or uses of this information, as well as
			...
			<p>
				...
				it in aggregate. If you’d like us to delete User Provided Data that you
				have provided via the Application, please contact us
				at&nbsp;privacy@applicationsite.com&nbsp;and we will respond in a
				reasonable time. Please note that some or all of the User Provided Data
			...
			<p>
				...
				at&nbsp;privacy@applicationsite.com. We will delete such information
			...
			<p>
				...
				Privacy Policy&nbsp;here&nbsp;and&nbsp;informing you via email or text
				message. You are advised to consult this Privacy Policy regularly for
				any changes, as continued use is deemed approval of all changes. You can
				check the history of this policy by clicking here.
			</p>
			<p>&nbsp;</p>
			<h4>
			...
			<p>
				...
				us. &quot;Processing,” means using cookies on a computer/hand held
				...
				information will be transferred, processed and stored there under United
